...
public class BondFuturesUtils {
  ...
  /**
   * Returns the EUREX bond futures conversion factor for a given Germany bond.
   * 
   * @param bond  the bond
  ...
  /**
   * Returns the ICE bond futures conversion factor for a given U.S. short bond (i.e. underlying of TU, 3YR, FV).
   * <p>
   * With n the number of whole years from the first day of the delivery month to the maturity (or call) date of 
   * the bond or note. The number of whole months between n-year after delivery and the maturity.
   * 
   * @param bond  the bond
   ...
   * <p>
   * With n the number of whole years from the first day of the delivery month to 
   * the maturity (or call) date of the bond or note.
