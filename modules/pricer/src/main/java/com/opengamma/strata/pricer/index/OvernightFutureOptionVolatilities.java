...
public interface OvernightFutureOptionVolatilities
  ...
  @Override
  public abstract OvernightFutureOptionVolatilities withParameter(int parameterIndex, double newValue);

  @Override
  public abstract OvernightFutureOptionVolatilities withPerturbation(ParameterPerturbation perturbation);
